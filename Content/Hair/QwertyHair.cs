...
{
    public class QwertyHair : ModHair
    {
    ...
    public class HairFront : PlayerDrawLayer
    {
        ...
        {
            if(drawInfo.drawPlayer.hair == QwertyHair.type)
            {
                //Main.NewText("Hair: " + drawInfo.drawPlayer.hair);
                Texture2D texture = ModContent.Request<Texture2D>("QwertyMod/Content/Hair/QwertyHair_Front").Value;
