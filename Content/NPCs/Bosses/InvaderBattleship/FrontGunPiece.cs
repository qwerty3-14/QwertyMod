...
namespace QwertyMod.Content.NPCs.Bosses.InvaderBattleship
{
    ...
    public class FrontGunPiece : ModNPC
    {
        ...
        public override bool PreDraw(SpriteBatch spriteBatch, Vector2 screenPos, Color drawColor)
        {
            ...
            Texture2D fragment = ModContent.Request<Texture2D>("QwertyMod/Content/NPCs/Bosses/InvaderBattleship/BattleshipDebris_Front").Value;
    ...
    public class BackGunPiece : ModNPC
    {
        ...
        {
            Texture2D hauler = ModContent.Request<Texture2D>("QwertyMod/Content/NPCs/Bosses/InvaderBattleship/DebrisHauler").Value;
            Texture2D fragment = ModContent.Request<Texture2D>("QwertyMod/Content/NPCs/Bosses/InvaderBattleship/BattleshipDebris_Back").Value;
