...
namespace QwertyMod.Content.Items.Consumable.Tiles.MusicBoxes
{
    public class MusicBoxBeastOfThreeHeads : ModItem
    {
        public override void SetStaticDefaults()
        {
            ...
            MusicLoader.AddMusicBox(Mod, MusicLoader.GetMusicSlot(Mod, "Assets/Music/BeastOfThreeHeads"), ModContent.ItemType<MusicBoxBeastOfThreeHeads>(), ModContent.TileType<MusicBoxBeastOfThreeHeadsT>());
        }
        ...
        public override void SetDefaults()
        {
            ...
            Item.createTile = ModContent.TileType<MusicBoxBeastOfThreeHeadsT>();
            Item.width = 24;
            Item.height = 24;
    ...
    public class MusicBoxBeastOfThreeHeadsT : ModTile
    {
        public override void SetStaticDefaults()
        {
