    ...
    public class FortressTrapT : ModTile
    {
        ...
        public override void HitWire(int i, int j)
        {
            if (Wiring.CheckMech(i, j, 60))
            {
                ...
                Projectile.NewProjectile(new ProjectileSource_Wiring(i, j), new Vector2(i, j) * 16 + new Vector2(8, 8) + velocity.SafeNormalize(-Vector2.UnitY) * 16, velocity, ProjectileType<FortressTrapP>(), 18, .5f, Main.myPlayer, 0f);
                Projectile.NewProjectile(new ProjectileSource_Wiring(i, j), new Vector2(i, j) * 16 + new Vector2(8, 8) + velocity.SafeNormalize(-Vector2.UnitY) * 16, velocity, ProjectileType<FortressTrapP>(), 18, .5f, Main.myPlayer, 20f);
            }
        }
    }
